...
After you have created a Cesium3DTileStyle object somewhere inside the project, you can import it into `constants.js` and add it to the `STYLING` variable. Styling is applied to all layers with tag `stylable`.
