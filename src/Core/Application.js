...
const STATES = {
    ...
    point: new PointMeasurementState(
        document.getElementById('pointMeasureBtn'),
    ),
...
class Application {
    ...
    constructor({
        ...
        this.viewer.scene.light.intensity = 3.5;
...
import {PointMeasurementState} from '../States/MeasurementStates/PointMeasurementState.js';
 ...
 * @type {Translator}
 */
const translator = new Translator(i18next.t);
