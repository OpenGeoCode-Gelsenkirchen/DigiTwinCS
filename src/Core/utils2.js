...
export function enterObjectEditMode(modelMatrix, index = undefined) {
    const winbox = document.getElementById('win-inspector').winbox;
    winbox.hide(false);
    winbox.hidden = false;
...
export function boundingBoxProjectCoordsToWGS(bb) {
    const bb1 = proj4('COORD', 'WGS84', [bb.left, bb.bottom]);
    const bb2 = proj4('COORD', 'WGS84', [bb.right, bb.top]);
