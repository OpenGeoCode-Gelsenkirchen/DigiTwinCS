...
//Monkey Patch Viewshed
Cesium.ShadowMap.createReceiveDerivedCommand =
    ShadowMap.createReceiveDerivedCommand;
 ...
 * @property {function} targetOnSetCallback- Invoked when camera/target are placed and shadow/post-process are built.
 *
...
export class Viewshed extends Primitive {
    constructor(
        ...
        this._fovX = fovX;
        this._fovY = fovY;
        this.cameraOnSetCallback = () => {};
        this.targetOnSetCallback = () => {};
        this.finished = false;
     ...
     */
    targetOnSet(callback) {
        this.targetOnSetCallback = () => {
            callback(this);
        };
    }

    cameraOnSet(callback) {
        this.cameraOnSetCallback = () => {
            callback(this);
        };
    }
     ...
     */
    _addPostProcess() {
        this.shadowMap.viewshed = {
            visibleColor: this.lightColor,
            shadowColor: this.shadowColor,
        };
        this.app.viewer.scene.shadowMap = this.shadowMap;
    }
