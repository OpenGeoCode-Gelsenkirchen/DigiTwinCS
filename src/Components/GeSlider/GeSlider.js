import '../GeInputField/GeInputField.js';
import styles from './GeSlider.css?raw';
import template from './GeSlider.html?raw';
...
export class GeSlider extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const start = this.getAttribute('start-value');

        this.html.input.step = this.getAttribute('step');
        this.html.input.value = start;
