 ...
 */
viewer.clock.onTick.addEventListener(currentClock => {
    const didUpdate = dataSourceDisplay.update(currentClock.currentTime);
    if (didUpdate) viewer.scene.requestRender();
});
