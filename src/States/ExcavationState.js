 ...
 * @property {GeInformationWindow} informationWindow - Modal window for excavation instructions.
 *
 * @example
...
export class ExcavationState extends State {
    ...
    async apply(app) {
        ...
        this.informationWindow = WindowFactory.createGeInformationWindow({
            title: i18next.t('common:body.excavation.edit.title'),
            message: i18next.t('common:body.excavation.edit.content'),
        });
